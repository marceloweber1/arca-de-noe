...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#page-top"><img src="img/logo.png"></a> </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#donation" class="page-scroll">Colabore</a></li>
...
<div class="quote first">
  <p>O ministério Arca de Noé foi fundado em 2012 com o propósito de resgatar, tratar,<br> cuidar e direcionar os animais resgatados para adoção</p>
</div>
<!-- Services Section -->
<div id="services">
  <div class="container">
    <div class="col-md-10 col-md-offset-1 section-title text-center">
      <h2>Serviços</h2>
      <hr>
      <p>Trabalhamos com equipe técnica especializada em todas as áreas.</p>
    </div>
    <div class="row">
...
<!-- Quote2 Section -->
<div class="quote">
  <p>Toda a renda é destinada aos tratamentos e manutenção dos animais abrigados pela instituição.</p>
</div>
<!-- Donation Section -->
<div id="donation">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4 text-center">
        ...
        <div class="service-desc">
          <h3>Doações</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam sedasd commodo nibh ante facilisis bibendum dolor feugiat at.</p>
          <a href="https://pagseguro.uol.com.br/checkout/nc/nl/donation/sender-identification.jhtml?t=9f098e86cc63cca49f769e6e5786ba2f#rmcl" class="btn btn-custom btn-lg page-scroll">Saber Mais</a>
        </div>
      </div>
      <div class="col-md-4 text-center">
...
<div id="footer">
  <div class="container text-center">
    <div class="col-md-8 col-md-offset-2">
      ...
      <p>&copy; 2017 Ministério Arca de Noé</p>
    </div>
  </div>
</div>
